		...
		<div class="content-main">
			...
			<div class="sidebar-container">
				...
				<div class="sidebar-content bg">
					<div class="container">
						<h2 style="text-align: center; color: white; padding: 30px;">Orders </h2>
						<div class="table-responsive">
							<table class="table table-bordered">
                                ...
                                <?php
                                    ...
                                    $records = mysqli_query($con, "SELECT cart.CustomerID, users.Name, users.Email, users.Address, cart.Price, cart.ID AS cartid from users INNER JOIN cart ON cart.CustomerID = users.ID WHERE `Paid` = '0'");                    
                                    $num = 1;
