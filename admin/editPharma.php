				...
				<div class="sidebar-content bg">
					<div class="row gx-0 justify-content-center" style="margin: 0 2%;">
						<div class="login-area col-sm-12 col-md-6 col-lg-5 col-xl-5 col-xxl-4">
							<h2 class="text-white text-center m-3">Edit Pharmacist</h2>
							<form action="editPharmaProc.php" method="POST" id="form" class="form-container">
								<div class="signup-main">
									<?php
											$ph_id = $_GET['ph_id'];
											$sql = mysqli_query($con, "SELECT * FROM users WHERE users.ID = '$ph_id'");
